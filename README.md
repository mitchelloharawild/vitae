...
- [Jessica Gorzo](https://github.com/dendroica/cv) This is an example using a custom template based on awesomecv by incorporating the comment solution in Issue 108
