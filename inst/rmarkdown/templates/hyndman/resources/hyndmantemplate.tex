...
\usepackage{booktabs,fontawesome,academicons}
\usepackage[utf8]{inputenc}
...
$if(www)$\\\faicon{home} & \href{$www$}{Test}$endif$%
...
$if(scholar)$\\\aiicon{googlescholar} & $scholar$$endif$%
$if(orcid)$\\\aiicon{orcid} & $orcid$$endif$%
}
...
\def\detailedsection#1{\begin{tabular}{llll}#1\end{tabular}}

% Templates for brief entries
% Arguments: what when with
\def\briefitem#1#2#3{#2 & #1 & #3 \\}
\def\briefsection#1{\begin{tabular}{lll}#1\end{tabular}}
