...
#4 & #1 & #2 & #3 \\ \multicolumn{4}{p{\textwidth}}{\begin{minipage}{\textwidth}\renewcommand{\labelitemi}{{\footnotesize\ding{228}}}
\begin{itemize}#5\end{itemize}\end{minipage}} \\
}
\def\educationsection#1{
\begin{tabular}{llll}#1\end{tabular}}
