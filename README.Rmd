...
- [Lampros Sp. Mouselimis](https://github.com/mlampros/My.CVitae) (using Github Actions and a docker image to - [Mitchell O'Hara-Wild](https://github.com/mitchelloharawild/CV)
- [Antonio Páez](https://github.com/paezha/Official-CV)
...
programmatically generate the CV file)
